...
export default function RegisterPage() {
  ...
  return (
    <div className="flex items-center justify-center min-h-[70vh]">
      ...
      >
        <div>
          <h1 className="text-2xl font-bold text-navy">Регистрация</h1>
          <p className="text-sm text-navy/60 mt-1">
            Присоединяйся к студенческому маркетплейсу
          </p>
        </div>
        ...
        <div className="border-t border-dotted border-navy/30 pt-4 text-center text-sm text-navy/70">
          Уже есть аккаунт?{" "}
          <Link to="/login" className="font-semibold underline text-navy">
            Войти
          </Link>
        </div>
      </form>
